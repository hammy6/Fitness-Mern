...
const navigation = [
  { name: 'login', href: '/login/page', current: true },
  { name: 'register', href: '/register/page', current: false },
  { name: 'reset', href: '/reset/page', current: false },
  { name: 'forgot', href: '/forgot/page', current: false },
]
const AuthNavigation = [
  { name: 'home', href: '/user/home', current: true },
  { name: 'workout', href: '/user/workout', current: false },
];
...
export default function Navbar({ children }) {
  ...
  return (
    <div className="min-h-full">
      ...
      <main>
        <div className="py-1 mx-auto -mt-12 max-w-7xl sm:px-6 lg:px-8">{children}</div>
      </main>
    </div>
  )
}
